...
SELECT "u"."UserId", "u"."Balance", "u"."Email", "u"."Name", "u"."Password"
FROM "Users" AS "u"
WHERE ("u"."Email" = "email@email.com") AND ("u"."Password" = "password")
LIMIT 1

--UPDATE Users SET Balance = 110 WHERE Email = "email@email.com"
